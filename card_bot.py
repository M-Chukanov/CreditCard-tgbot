...
bot = TeleBot(token='5512868073:AAFyU-cdNybjNz-el5ICm6EXKxecUoPJkuo', parse_mode='html') # создание бота
...
def message_handler(message: types.Message):
    ...
    # card_type может принимать одно из зачений ['mastercard', 'visa13', 'visa16', 'visa19']
